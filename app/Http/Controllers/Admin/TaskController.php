    ...
    public function createReportTask(CreateReportTaskRequest $request){
        ...
        if($count_task > 0){ 
            ...
            foreach($tasks as $task){
                ...
                $html .= "<br><br><br><br><br><br><br><br><br><div style=\"text-align: center;font-weight: bold; font-size: 26px;\">". $activity_name  ."</div>";
                $html .= "<div style=\"text-align: justify; padding-left: 80px; padding-right:80px; \">
                            <div style=\"vertical-align: top; max-width: 50%; display: inline-block; font-size: 18px;\">".  str_replace(";","<br>",$description) ."</div>
                            </div>";
