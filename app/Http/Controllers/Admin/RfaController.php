    ...
    public function createReportRFA(Rfa $rfa)
    {
       $submittalsRfa = SubmittalsRfa::all()->where('on_rfa_id' , $rfa->id);
        ...
        $html .= "<div style=\"font-size: 14px; position:absolute;top:360px;left:210px;\">" . $contract_drawing_no . "</div>";
          //Note
        $html .= "<div style=\"font-size: 12px; padding-right:60px; position:absolute;top:382px;left:120px;LINE-HEIGHT:15px;\">" 
        . $note_1 . "</div>";
        ...
        //Stamp Organize
        if($stamp_path != ''){
            $html .= "<div style=\"font-size: 14px; position:absolute;top:350px;left:600px;\">
                <img src=\"". $stamp_path ."\" width=\"100px\" higth=\"100px\" style=\"opacity: 0.8;\"> </div>";
        }
       ...
       if($for_statuses == 1){
        ...
        if(count($submittalsRfa) > 0){
            ...
            foreach($submittalsRfa as $submittal){
                ...
                $htmlsub = "<div style=\"font-size: 10px; padding-right:660px; position:absolute;top:". $top ."px;left:50px;LINE-HEIGHT:15px;\">". 
