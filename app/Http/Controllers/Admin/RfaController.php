...
//            $data['document_number'] = 'HSR1/' . $const_code . $workcode  . '/' . $wbs3code . '/' . $wbs4code . '/' . $typecode . '/' . $code_date . '/' . $doc_number;
    ...
    try {
        ...
        if(strlen($title_en) > 210){
            $html .= "<div style=\"font-size: 8.5px; padding-right:240px; position:absolute;top:186px;left:80px; LINE-HEIGHT:16px;\">"
            . $title_en . "</div>";
        }
        else{
        ...
        if(strlen($title_th) > 235){
            $html .= "<div style=\"font-size: 8.5px; padding-right:230px; position:absolute;top:236px;left:80px; LINE-HEIGHT:14px;\">"
            . $title_th . "</div>";
        }
        else{
