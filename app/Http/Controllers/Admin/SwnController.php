...
class SwnController extends Controller
{
    ...
    public function createReportSWN(Swn $swn){
        ...
        $cutoffDate = Carbon::createFromFormat('d/m/Y', '26/05/2026')->endOfDay();
        ...
        $html = "<div style=\"font-size: 10px; text-align: center; font-weight: bold; color:#1F4E78;position:absolute;top:145px;left:250px;\">" . $contract_name  . "</div>";
        ...
        $des .= "<div style=\"font-size: 9px; padding-right:50px; position:absolute;top:380px;left:110px;LINE-HEIGHT:15px;\">" . $description  . "</div>";
        $des .= "</div>";
