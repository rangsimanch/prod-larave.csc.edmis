...
use App\Http\Requests\MassDestroyLetterIncomingCecRequest;
...
class LetterIncomingCecController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.letterIncomingCecs.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.letterIncomingCecs.create', compact('letters'));
    }
    ...
    public function store(StoreLetterIncomingCecRequest $request)
    {
        ...
        return redirect()->route('admin.letter-incoming-cecs.index');
    }

    public function edit(LetterIncomingCec $letterIncomingCec)
    {
        abort_if(Gate::denies('letter_incoming_cec_edit'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        $letters = AddLetter::all()->pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');

        $letterIncomingCec->load('letter', 'team');

        return view('admin.letterIncomingCecs.edit', compact('letters', 'letterIncomingCec'));
    }
    ...
    public function show(LetterIncomingCec $letterIncomingCec)
    {
        ...
        return view('admin.letterIncomingCecs.show', compact('letterIncomingCec'));
    }
    ...
    public function massDestroy(MassDestroyLetterIncomingCecRequest $request)
    {
        LetterIncomingCec::whereIn('id', request('ids'))->delete();
