...
class NcnController extends Controller
{
    ...
    public function createReportNCN(ncn $ncn){
        ...
        if($ncn_id <= 93){
            ...
            $html = "<div style=\" padding-left: 80px; padding-right:40px; padding-bottom:-30px; \">";
            $html .= "<div style=\"font-size: 12px; position:absolute;top:230px;left:105px;LINE-HEIGHT:18px;\">" . $description  . "</div>";
            $html .= "</div>";
        }
        else{
            // $header_len = strlen($contract_header);
