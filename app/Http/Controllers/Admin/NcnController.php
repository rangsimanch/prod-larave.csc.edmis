...
class NcnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Ncn::with(['construction_contract', 'issue_by', 'related_specialist', 'leader', 'construction_specialist', 'team'])->select(sprintf('%s.*', (new Ncn())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'construction_contract', 'file_attachment', 'issue_by', 'related_specialist', 'leader', 'construction_specialist']);
        ...
        return view('admin.ncns.index', compact('construction_contracts', 'users', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ncns.create', compact('construction_contracts', 'construction_specialists', 'issue_bies', 'leaders', 'related_specialists'));
    }
    ...
    public function edit(Ncn $ncn)
    {
        ...
        $ncn->load('construction_contract', 'issue_by', 'related_specialist', 'leader', 'construction_specialist', 'team');

        return view('admin.ncns.edit', compact('construction_contracts', 'construction_specialists', 'issue_bies', 'leaders', 'ncn', 'related_specialists'));
    }
