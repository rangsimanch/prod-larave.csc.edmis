...
class PmcSentController extends Controller
{
    ...
    {
        abort_if(Gate::denies('pmc_sent_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        if ($request->ajax()) {
        ...
        return view('admin.pmcSents.index', compact('letter_subject_types','teams', 'teams', 'teams', 'construction_contracts', 'users', 'users', 'teams'));        
    }
}
