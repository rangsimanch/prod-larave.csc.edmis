...
class RequestForInformationController extends Controller
{
    ...
    public function createReportRFI(RequestForInformation $rfi)
    {
        ...
        $html .= "<div style=\"font-size: 10px; position:absolute;top:155px;left:575px;\">" . $constructor_name  . '.' . "</div>";
        ...
        $html .= "<div style=\"font-size: 13px; padding-right:350px; position:absolute;top:277px;left:110px;\">" . $title  . '.' . "</div>";
