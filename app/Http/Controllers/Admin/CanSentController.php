...
class CanSentController extends Controller
{
    public function index(Request $request)
    {
        ...
        session(['previous-url' => route('admin.can-sents.index')]);
        return view('admin.canSents.index', compact('letter_subject_types','teams', 'teams', 'teams', 'construction_contracts', 'users', 'users', 'teams'));        
    }
}
