...
class CcspSentController extends Controller
{
    ...
    {
        abort_if(Gate::denies('ccsp_sent_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        ...
        return view('admin.ccspSents.index', compact('letter_subject_types','teams', 'teams', 'teams', 'construction_contracts', 'users', 'users', 'teams'));       
    }
}
