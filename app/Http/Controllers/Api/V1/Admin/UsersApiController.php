...
class UsersApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new UserResource(User::with(['team', 'jobtitle', 'roles', 'construction_contract'])->get());
    }
    ...
    public function show(User $user)
    {
        ...
        return new UserResource($user->load(['team', 'jobtitle', 'roles', 'construction_contract']));
    }
