...
class DocumentsAndAssignmentsApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new DocumentsAndAssignmentResource(DocumentsAndAssignment::with(['construction_contract'])->get());
    }
    ...
    public function show(DocumentsAndAssignment $documentsAndAssignment)
    {
        ...
        return new DocumentsAndAssignmentResource($documentsAndAssignment->load(['construction_contract']));
    }
