        ...
        return RequestForInformationResource::collection($rfis)->response()->setData(
            $rfis->map(function ($rfi) {
                ...
                return [
                    ...
                    'status' => $rfi->document_status ? $rfi->document_status : '' ,
                    ...
                    'incoming_date' => $rfi->incoming_date ? $rfi->incoming_date->format('d/m/Y') : '',
                    'outgoing_no' => $rfi->outgoing_no ? $rfi->outgoing_no : '',
                    'outgoing_date' => $rfi->outgoing_date ? $rfi->outgoing_date->format('d/m/Y') : '',
