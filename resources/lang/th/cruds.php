...
return [
    ...
    'constructionContract'   => [
        ...
        'fields'         => [
            ...
            'id_helper'                => '',
            'name'                     => 'name',
            'name_helper'              => 'Construction Contract name',
            'code'                     => 'Code',
            'code_helper'              => 'Construction Contract Code (eg. C2-1)',
            'dk_start_1'               => 'DK Start (1)',
            'dk_start_1_helper'        => 'DK Start (1)',
            'dk_end_1'                 => 'DK End (1)',
            'dk_end_1_helper'          => 'DK End (1)',
            'dk_start_2'               => 'DK Start (2)',
            'dk_start_2_helper'        => 'DK Start (2) - Optional',
            'dk_end_2'                 => 'DK End (2)',
            'dk_end_2_helper'          => 'DK End (2) - Optional',
            'dk_start_3'               => 'DK Start (3)',
            'dk_start_3_helper'        => 'DK Start (3) - Optional',
            'dk_end_3'                 => 'DK End (3)',
            'dk_end_3_helper'          => 'DK Start (3) - Optional',
