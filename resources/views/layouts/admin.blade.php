...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/v/bs/jq-3.6.0/jszip-2.5.0/dt-1.11.4/af-2.3.7/b-2.2.2/b-colvis-2.2.2/b-html5-2.2.2/b-print-2.2.2/cr-1.5.5/date-1.1.2/fh-3.2.1/kt-2.6.4/r-2.2.9/rg-1.1.4/rr-1.2.8/sc-2.0.5/sb-1.3.1/sp-1.4.0/sl-1.3.4/sr-1.1.0/datatables.min.css" />

    <link rel="icon"
        href="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Taiwan_High_Speed_Rail_symbol.svg/1200px-Taiwan_High_Speed_Rail_symbol.svg.png">
    <link rel="stylesheet" type="text/css"
    ...
    <link href="https:////cdn.datatables.net/plug-ins/1.11.4/features/pageResize/dataTables.pageResize.min.js"
        rel="stylesheet" />
...
<body class="sidebar-mini skin-red" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
                                ...
                                <li align="center" class="well">
                                    @if (Auth::user()->img_user != '')
                                        <div align="center"><img class="img-responsive"
                                                style="padding:2%; width:90px; height:90px;"
                                                src="{{ \Auth::user()->img_user->getUrl('thumb') }}" /></div>
                                    @else
                                        <div align="center"><img class="img-responsive"
                                                style="padding:2%; width:90px; height:90px;"
                                                src="https://static.asianetnews.com/img/default-user-avatar.png" />
                                        </div>
                                    @endif
                                    <a href="{{ route('admin.users.edit', \Auth::id()) }}"
                                        class="btn btn-sm btn-default"><span class="glyphicon glyphicon-co"></span>
                                        Settings</a>
                                    <a href="#"
                                        onclick="event.preventDefault(); document.getElementById('logoutform').submit();"><span
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                @can('construction_contract_select')
                                    {!! Form::open([
                                        'method' => 'POST',
                                        'url' => route('admin.construction_contracts-select.select'),
                                        'id' => 'navbar__select-construction_contract-form',
                                    ]) !!}
                                    {!! Form::hidden('redirect', 'back') !!}
                                    {!! Form::select(
                                        'construction_contract_id',
                                        Auth::user()->construction_contracts->pluck('code', 'id'),
                                        session('construction_contract_id'),
                                        ['class' => 'select3', 'id' => 'navbar__select-construction_contract'],
                                    ) !!}
                                    {!! Form::close() !!}
                                    @endif
                                </a>
        ...
        <script
            src="https://unpkg.com/bootstrap-table@1.15.5/dist/extensions/filter-control/bootstrap-table-filter-control.min.js">
        </script>
