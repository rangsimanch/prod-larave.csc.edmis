        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="container px-4 mx-auto">
                    ...
                    <center><h1 style="font-family: 'Kanit', sans-serif; line-height:45px;">ประกาศการปรับปรุงระบบ<br></h1>
                    <h3 style="font-family: 'Kanit', sans-serif; line-height:45px;">ขณะนี้เราได้ทำการปรับปรุงความปลอดภัยของระบบให้แน่นหนามากขึ้น จึงทำให้ข้อมูลก่อนวันที่ 17 สิงหาคม 2565 <br> ไม่สามารถเปิดใช้งานได้ชั่วคราว 
                    ซึ่งข้อมูลทั้งหมดจะสามารถใช้งานได้ในเร็วๆนี้ ทางเราจะเร่งแก้ไขให้โดยด่วน <br> ขออภัยในความไม่สะดวกครับ</h3></center>
