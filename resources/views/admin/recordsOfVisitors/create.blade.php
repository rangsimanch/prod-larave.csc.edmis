        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.recordsOfVisitor.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.records-of-visitors.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('name_of_visitor') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name_of_visitor" id="name_of_visitor" value="{{ old('name_of_visitor', '') }}">
