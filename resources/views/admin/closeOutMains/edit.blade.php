                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.close-out-mains.update", [$closeOutMain->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('chapter_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chapter_no" id="chapter_no" value="{{ old('chapter_no', $closeOutMain->chapter_no) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $closeOutMain->title) }}" required>
                            @if($errors->has('title'))
