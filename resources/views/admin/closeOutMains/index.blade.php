...
{ data: 'closeout_subject_subject', name: 'closeout_subject.subject', searchable: false },
{ data: 'detail', name: 'detail' },
{ data: 'quantity', name: 'quantity', searchable: false },
{ data: 'ref_documents', name: 'ref_documents', searchable: false },
{ data: 'final_file', name: 'final_file', sortable: false, searchable: false },
{ data: 'closeout_url', name: 'closeout_urls.filename', searchable: false },
{ data: 'ref_rfa_text', name: 'ref_rfa_text', searchable: false },
    ],
    orderCellsTop: true,
    order: [[ 2, 'desc' ]],
    pageLength: 10,
