                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.add-letters.update", [$addLetter->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('topic_categories') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="topic_categories[]" id="topic_categories" multiple>
                                @foreach($topic_categories as $id => $topic_category)
                                    <option value="{{ $id }}" {{ (in_array($id, old('topic_categories', [])) || $addLetter->topic_categories->contains($id)) ? 'selected' : '' }}>{{ $topic_category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('responsible') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="responsible_id" id="responsible_id">
                                @foreach($responsibles as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('responsible_id') ? old('responsible_id') : $addLetter->responsible->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $addLetter->start_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('complete_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="complete_date" id="complete_date" value="{{ old('complete_date', $addLetter->complete_date) }}">
