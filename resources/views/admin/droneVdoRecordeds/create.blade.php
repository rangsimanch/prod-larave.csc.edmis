        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.droneVdoRecorded.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drone-vdo-recordeds.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('work_tiltle') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="work_tiltle" id="work_tiltle" value="{{ old('work_tiltle', '') }}">
