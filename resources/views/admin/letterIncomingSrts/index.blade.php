...
@section('content')
<div class="content">
    @can('letter_incoming_srt_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route("admin.letter-incoming-srts.create") }}">
                    {{ trans('global.add') }} {{ trans('cruds.letterIncomingSrt.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.letterIncomingSrt.title_singular') }} {{ trans('global.list') }}
                </div>
...
@can('letter_incoming_srt_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.letter-incoming-srts.massDestroy') }}",
...
let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.letter-incoming-srts.index') }}",
    columns: [
