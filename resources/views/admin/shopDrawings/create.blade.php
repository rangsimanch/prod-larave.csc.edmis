        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.shopDrawing.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.shop-drawings.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('shop_drawing_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_drawing_title" id="shop_drawing_title" value="{{ old('shop_drawing_title', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('drawing_references') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="drawing_references[]" id="drawing_references" multiple>
                                @foreach($drawing_references as $id => $drawing_reference)
                                    <option value="{{ $id }}" {{ in_array($id, old('drawing_references', [])) ? 'selected' : '' }}>{{ $drawing_reference }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('coding_of_shop_drawing') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="coding_of_shop_drawing" id="coding_of_shop_drawing" value="{{ old('coding_of_shop_drawing', '') }}">
