        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.srtPeDocument.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.srt-pe-documents.store") }}" enctype="multipart/form-data">
                        @csrf
...
Dropzone.options.fileUploadDropzone = {
    url: '{{ route('admin.srt-pe-documents.storeMedia') }}',
    maxFilesize: 500, // MB
    addRemoveLinks: true,
    headers: {
    ...
    init: function () {
@if(isset($srtPeDocument) && $srtPeDocument->file_upload)
          var files =
            {!! json_encode($srtPeDocument->file_upload) !!}
              for (var i in files) {
              var file = files[i]
