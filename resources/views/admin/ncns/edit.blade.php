                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.ncns.update", [$ncn->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('document_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="document_number" id="document_number" value="{{ old('document_number', $ncn->document_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('issue_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="issue_date" id="issue_date" value="{{ old('issue_date', $ncn->issue_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('documents_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="documents_status" id="documents_status">
                                ...
                                @foreach(App\Ncn::DOCUMENTS_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('documents_status', $ncn->documents_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('related_specialist') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="related_specialist_id" id="related_specialist_id">
                                @foreach($related_specialists as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('related_specialist_id') ? old('related_specialist_id') : $ncn->related_specialist->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
