...
@section('content')
<div class="content">
    @can('interim_payment_meeting_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.interim-payment-meetings.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.interimPaymentMeeting.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.interimPaymentMeeting.title_singular') }} {{ trans('global.list') }}
                </div>
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-InterimPaymentMeeting">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('interim_payment_meeting_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.interim-payment-meetings.massDestroy') }}",
...
{ data: 'actions', name: '{{ trans('global.actions') }}', searchable: false }
  ...
  let table = $('.datatable-InterimPaymentMeeting').DataTable(dtOverrideGlobals);
