        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.uniqueInbox.title_singular') }} {{ trans('global.list') }}
                </div>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.unique-inboxes.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder', searchable: false },
{ data: 'actions', name: '{{ trans('global.actions') }}', searchable: false },
{ data: 'status', name: 'status', searchable: false },

{ data: 'letter_type', name: 'letter_type', searchable: false },
{ data: 'topic_category', name: 'topic_categories.subject_name', searchable: false },
{ data: 'title', name: 'title' },
{ data: 'letter_no', name: 'letter_no' },
{ data: 'sent_date', name: 'sent_date', searchable: false },
{ data: 'sender_code', name: 'sender.code', searchable: false },
{ data: 'receiver_code', name: 'receiver.code', searchable: false },
{ data: 'received_date', name: 'received_date', searchable: false },
{ data: 'cc_to', name: 'cc_tos.code', searchable: false },
...
{ data: 'responsible_name', name: 'responsible.name', searchable: false },
{ data: 'start_date', name: 'start_date', searchable: false },
{ data: 'complete_date', name: 'complete_date', searchable: false },
{ data: 'processing_time', name: 'processing_time', searchable: false },
    ],
    orderCellsTop: true,
    order: [[ 7, 'desc' ]],
    pageLength: 25,
