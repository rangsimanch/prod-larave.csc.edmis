        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.nonConformanceReport.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.non-conformance-reports.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('ncn_ref') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="ncn_ref_id" id="ncn_ref_id">
                                @foreach($ncn_refs as $id => $ncn_ref)
                                    <option value="{{ $id }}" {{ old('ncn_ref_id') == $id ? 'selected' : '' }}>{{ $ncn_ref }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('corrective_action') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="corrective_action" id="corrective_action">{{ old('corrective_action') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('preventive_action') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="preventive_action" id="preventive_action">{{ old('preventive_action') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('prepared_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="prepared_by_id" id="prepared_by_id">
                                @foreach($prepared_bies as $id => $prepared_by)
                                    <option value="{{ $id }}" {{ old('prepared_by_id') == $id ? 'selected' : '' }}>{{ $prepared_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('contractors_project') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="contractors_project_id" id="contractors_project_id">
                                @foreach($contractors_projects as $id => $contractors_project)
                                    <option value="{{ $id }}" {{ old('contractors_project_id') == $id ? 'selected' : '' }}>{{ $contractors_project }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('csc_consideration_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="csc_consideration_status" id="csc_consideration_status">
                                ...
                                @foreach(App\NonConformanceReport::CSC_CONSIDERATION_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('csc_consideration_status', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('csc_disposition_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="csc_disposition_status" id="csc_disposition_status">
                                ...
                                @foreach(App\NonConformanceReport::CSC_DISPOSITION_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('csc_disposition_status', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('cc_srt') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cc_srt" id="cc_srt" value="1" {{ old('cc_srt', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('cc_pmc') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cc_pmc" id="cc_pmc" value="1" {{ old('cc_pmc', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('cc_cec') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cc_cec" id="cc_cec" value="1" {{ old('cc_cec', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('cc_csc') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="cc_csc" id="cc_csc" value="1" {{ old('cc_csc', 0) == 1 ? 'checked' : '' }}>
