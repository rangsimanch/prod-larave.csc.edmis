        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.rfatypes.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('type_name') ? 'has-error' : '' }}">
                            <label for="type_name">{{ trans('cruds.rfatype.fields.type_name') }}</label>
                            <input class="form-control" type="text" name="type_name" id="type_name" value="{{ old('type_name', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('type_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="type_code" id="type_code" value="{{ old('type_code', '') }}">
