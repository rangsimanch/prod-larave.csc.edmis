...
@section('content')
<div class="content">
    @can('check_list_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.check-lists.create') }}">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CheckList">
                        <thead>
                            <tr>
                                <th width="10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="search" strict="true">
                                        <option value>{{ trans('global.all') }}</option>
                                        @foreach(App\CheckList::THAI_OR_CHINESE_WORK_SELECT as $key => $item)
                                            <option value="{{ $item }}">{{ $item }}</option>
                                        @endforeach
                                    </select>
                                </td>
...
@can('check_list_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.check-lists.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.check-lists.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder', searchable: false },
{ data: 'work_type_name', name: 'work_type.name', searchable: false },
{ data: 'work_title', name: 'work_title' },
{ data: 'location', name: 'location' },
{ data: 'date_of_work_done', name: 'date_of_work_done', searchable: false },
{ data: 'name_of_inspector_name', name: 'name_of_inspector.name', searchable: false },
{ data: 'thai_or_chinese_work', name: 'thai_or_chinese_work', searchable: false },
...
{ data: 'actions', name: '{{ trans('global.actions') }}', searchable: false }
  ...
  let table = $('.datatable-CheckList').DataTable(dtOverrideGlobals);
