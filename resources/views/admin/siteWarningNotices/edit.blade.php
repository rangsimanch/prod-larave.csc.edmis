        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.siteWarningNotice.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.site-warning-notices.update", [$siteWarningNotice->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                            <label for="subject">{{ trans('cruds.siteWarningNotice.fields.subject') }}</label>
                            <input class="form-control" type="text" name="subject" id="subject" value="{{ old('subject', $siteWarningNotice->subject) }}">
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $siteWarningNotice->location) }}">
                        ...
                        <div class="form-group {{ $errors->has('reply_by_ncr') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="reply_by_ncr" id="reply_by_ncr">
                                ...
                                @foreach(App\SiteWarningNotice::REPLY_BY_NCR_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('reply_by_ncr', $siteWarningNotice->reply_by_ncr) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('swn_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="swn_no" id="swn_no" value="{{ old('swn_no', $siteWarningNotice->swn_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('submit_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="submit_date" id="submit_date" value="{{ old('submit_date', $siteWarningNotice->submit_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('to_team') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="to_team_id" id="to_team_id">
                                @foreach($to_teams as $id => $to_team)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->to_team ? $siteWarningNotice->to_team->id : old('to_team_id')) == $id ? 'selected' : '' }}>{{ $to_team }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('construction_contract') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="construction_contract_id" id="construction_contract_id">
                                @foreach($construction_contracts as $id => $construction_contract)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->construction_contract ? $siteWarningNotice->construction_contract->id : old('construction_contract_id')) == $id ? 'selected' : '' }}>{{ $construction_contract }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $siteWarningNotice->description) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('issue_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="issue_by_id" id="issue_by_id">
                                @foreach($issue_bies as $id => $issue_by)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->issue_by ? $siteWarningNotice->issue_by->id : old('issue_by_id')) == $id ? 'selected' : '' }}>{{ $issue_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('reviewed_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="reviewed_by_id" id="reviewed_by_id">
                                @foreach($reviewed_bies as $id => $reviewed_by)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->reviewed_by ? $siteWarningNotice->reviewed_by->id : old('reviewed_by_id')) == $id ? 'selected' : '' }}>{{ $reviewed_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('root_cause') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="root_cause" id="root_cause">{{ old('root_cause', $siteWarningNotice->root_cause) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('containment_actions') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="containment_actions" id="containment_actions">{!! old('containment_actions', $siteWarningNotice->containment_actions) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('containment_responsible') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="containment_responsible_id" id="containment_responsible_id">
                                @foreach($containment_responsibles as $id => $containment_responsible)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->containment_responsible ? $siteWarningNotice->containment_responsible->id : old('containment_responsible_id')) == $id ? 'selected' : '' }}>{{ $containment_responsible }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('containment_completion_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="containment_completion_date" id="containment_completion_date" value="{{ old('containment_completion_date', $siteWarningNotice->containment_completion_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('corrective_and_preventive') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="corrective_and_preventive" id="corrective_and_preventive">{!! old('corrective_and_preventive', $siteWarningNotice->corrective_and_preventive) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('corrective_responsible') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="corrective_responsible_id" id="corrective_responsible_id">
                                @foreach($corrective_responsibles as $id => $corrective_responsible)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->corrective_responsible ? $siteWarningNotice->corrective_responsible->id : old('corrective_responsible_id')) == $id ? 'selected' : '' }}>{{ $corrective_responsible }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('corrective_completion_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="corrective_completion_date" id="corrective_completion_date" value="{{ old('corrective_completion_date', $siteWarningNotice->corrective_completion_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('section_2_reviewed_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="section_2_reviewed_by_id" id="section_2_reviewed_by_id">
                                @foreach($section_2_reviewed_bies as $id => $section_2_reviewed_by)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->section_2_reviewed_by ? $siteWarningNotice->section_2_reviewed_by->id : old('section_2_reviewed_by_id')) == $id ? 'selected' : '' }}>{{ $section_2_reviewed_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('section_2_approved_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="section_2_approved_by_id" id="section_2_approved_by_id">
                                @foreach($section_2_approved_bies as $id => $section_2_approved_by)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->section_2_approved_by ? $siteWarningNotice->section_2_approved_by->id : old('section_2_approved_by_id')) == $id ? 'selected' : '' }}>{{ $section_2_approved_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('review_and_judgement_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="review_and_judgement_status" id="review_and_judgement_status">
                                ...
                                @foreach(App\SiteWarningNotice::REVIEW_AND_JUDGEMENT_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('review_and_judgement_status', $siteWarningNotice->review_and_judgement_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="note" id="note">{{ old('note', $siteWarningNotice->note) }}</textarea>
                            @if($errors->has('note'))
                        ...
                        <div class="form-group {{ $errors->has('csc_issuer') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="csc_issuer_id" id="csc_issuer_id">
                                @foreach($csc_issuers as $id => $csc_issuer)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->csc_issuer ? $siteWarningNotice->csc_issuer->id : old('csc_issuer_id')) == $id ? 'selected' : '' }}>{{ $csc_issuer }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('csc_qa') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="csc_qa_id" id="csc_qa_id">
                                @foreach($csc_qas as $id => $csc_qa)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->csc_qa ? $siteWarningNotice->csc_qa->id : old('csc_qa_id')) == $id ? 'selected' : '' }}>{{ $csc_qa }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('disposition_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="disposition_status" id="disposition_status">
                                ...
                                @foreach(App\SiteWarningNotice::DISPOSITION_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('disposition_status', $siteWarningNotice->disposition_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('csc_pm') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="csc_pm_id" id="csc_pm_id">
                                @foreach($csc_pms as $id => $csc_pm)
                                    <option value="{{ $id }}" {{ ($siteWarningNotice->csc_pm ? $siteWarningNotice->csc_pm->id : old('csc_pm_id')) == $id ? 'selected' : '' }}>{{ $csc_pm }}</option>
                                @endforeach
                            </select>
