                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.swns.update", [$swn->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('document_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="document_number" id="document_number" value="{{ old('document_number', $swn->document_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('submit_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="submit_date" id="submit_date" value="{{ old('submit_date', $swn->submit_date) }}">
