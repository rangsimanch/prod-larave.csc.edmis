...
{ data: 'documents_status', name: 'documents_status', searchable: false },
...
{ data: 'issue_by_name', name: 'issue_by.name', searchable: false },
{ data: 'responsible_name', name: 'responsible.name', searchable: false },
{ data: 'related_specialist_name', name: 'related_specialist.name', searchable: false },
{ data: 'review_status', name: 'review_status', searchable: false },
{ data: 'construction_specialist_name', name: 'construction_specialist.name', searchable: false },
{ data: 'leader_name', name: 'leader.name', searchable: false },
{ data: 'auditing_status', name: 'auditing_status', searchable: false },
    ],
    orderCellsTop: true,
    order: [[ 7, 'desc' ]],
    pageLength: 10,
