        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.downloadSystemActivity.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.download-system-activities.update", [$downloadSystemActivity->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('activity_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="activity_title" id="activity_title" value="{{ old('activity_title', $downloadSystemActivity->activity_title) }}">
