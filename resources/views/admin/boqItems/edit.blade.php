        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.boqItem.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.boq-items.update", [$boqItem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $boqItem->code) }}">
                            @if($errors->has('code'))
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $boqItem->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('unit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="unit" id="unit" value="{{ old('unit', $boqItem->unit) }}">
                            @if($errors->has('unit'))
                        ...
                        <div class="form-group {{ $errors->has('quantity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $boqItem->quantity) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('unit_rate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="unit_rate" id="unit_rate" value="{{ old('unit_rate', $boqItem->unit_rate) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $boqItem->amount) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('factor_f') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="factor_f" id="factor_f" value="{{ old('factor_f', $boqItem->factor_f) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('total_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $boqItem->total_amount) }}" step="0.01">
