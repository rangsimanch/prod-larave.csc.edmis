        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.rfa-document-statuses.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('status_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="status_name" id="status_name" value="{{ old('status_name', '') }}">
