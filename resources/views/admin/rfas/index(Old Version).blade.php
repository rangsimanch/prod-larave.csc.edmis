        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Rfa text-center display pageResize"  id="datatb">
                        <thead>
                            <tr>
                                <th width="10">
                                ...
                                <th>
                                    ...
                                    placeholder="Search for title(EN)..." data-column="9"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.title') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for title(TH)..." data-column="10"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.title_cn') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for title(CN)..." data-column="11"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.origin_number') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Origin Number..." data-column="12"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.document_number') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Document Number..." data-column="13"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.rfa_code') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for RFA code..." data-column="14"/>
                                </th>
                                <th>
                                ...
                                <th>
                                    ...
                                    <select class="form-control filter-select" data-column="19">
                                ...
                                <th>
                                    ...
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Issue by..." data-column="21"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.assign') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Assign to..." data-column="22"/>
                                </th>
                                ...
                                <th>
                                    ...
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Spec. Ref.No. ..." data-column="23"/>
                                </th>
                                <th>
                                ...
                                <th>
                                    ...
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Contract Drawing No. ..." data-column="26"/>
                                </th>

                                <th>
                                    {{ trans('cruds.rfa.fields.action_by') }}
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Action by..." data-column="27"/>
                                </th>
                                ...
                                <th>
                                    ...
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Comment by..." data-column="28"/>
                                </th>
                                <th>
                                    {{ trans('cruds.rfa.fields.information_by') }}

                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Information by..." data-column="29"/>
                                </th>
                                <th>
                                ...
                                <th>
                                    ...
                                    <input type="text" class="form-control filter-input"
                                    placeholder="Search for Information by..." data-column="35"/>
                                </th>
                                ...
                                <th>
                                    ...
                                    <select class="form-control filter-select" data-column="37">
                                        <option value=""> Select Status... </option>
...
{ data: 'date_counter', name: 'date_counter',visible: false },// 4
{ data: 'document_status_status_name', name: 'document_status.status_name', sortable: false}, // 5
{ data: 'file_upload_1', name: 'file_upload_1', sortable: false, searchable: false }, // 6
{ data: 'submittals_file', name: 'submittals_file', sortable: false, searchable: false, visible: false }, // 7
{ data: 'boq_name', name: 'boq.name', sortable: false}, // 8
{ data: 'title_eng', name: 'title_eng',sortable: false, }, // 9
{ data: 'title', name: 'title' ,sortable: false,}, // 10
{ data: 'title_cn', name: 'title_cn' ,visible: false, sortable: false, }, // 11
{ data: 'origin_number', name: 'origin_number', sortable: false, }, // 12
{ data: 'document_number', name: 'document_number',sortable: false, }, // 13
{ data: 'rfa_code', name: 'rfa_code' }, // 14
{ data: 'type.type_code', name: 'type.type_code' , visible: false}, // 15
{ data: 'worktype', name: 'worktype' , visible: false}, // 16
{ data: 'construction_contract_code', name: 'construction_contract.code' ,visible: false , sortable: false,}, // 17
{ data: 'wbs_level_3_wbs_level_3_code', name: 'wbs_level_3.wbs_level_3_code' , visible: false, sortable: false,}, // 18
{ data: 'wbs_level_4_wbs_level_4_code', name: 'wbs_level_4.wbs_level_4_code' , visible: false, sortable: false, }, // 19
{ data: 'submit_date', name: 'submit_date' ,  sortable: false, }, // 20
{ data: 'issueby_name', name: 'issueby.name' , visible: false, sortable: false,}, // 21
{ data: 'assign_name', name: 'assign.name' , visible: false, sortable: false,}, // 22

{ data: 'qty_page', name: 'qty_page' ,visible: false, sortable: false,}, // 23
{ data: 'spec_ref_no', name: 'spec_ref_no' , visible: false ,visible: false, sortable: false,}, // 24
{ data: 'clause', name: 'clause' , visible: false, visible: false, sortable: false,}, // 25
{ data: 'contract_drawing_no', name: 'contract_drawing_no' , visible: false , visible: false, sortable: false,}, // 26
{ data: 'action_by_name', name: 'action_by.name' , sortable: false, visible: false}, // 27
{ data: 'comment_by_name', name: 'comment_by.name' ,visible: false, sortable: false,}, // 28
{ data: 'information_by_name', name: 'information_by.name' ,visible: false, sortable: false,}, // 29
