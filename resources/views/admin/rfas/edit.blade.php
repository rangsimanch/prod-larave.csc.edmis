    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.rfas.update", [$rfa->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $rfa->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('document_number') ? 'is-invalid' : '' }}" type="text" name="document_number" id="document_number" value="{{ old('document_number', $rfa->document_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rfa_code') ? 'is-invalid' : '' }}" type="text" name="rfa_code" id="rfa_code" value="{{ old('rfa_code', $rfa->rfa_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('submit_date') ? 'is-invalid' : '' }}" type="text" name="submit_date" id="submit_date" value="{{ old('submit_date', $rfa->submit_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('note_1') ? 'is-invalid' : '' }}" name="note_1" id="note_1">{!! old('note_1', $rfa->note_1) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('create_by') ? 'is-invalid' : '' }}" name="create_by_id" id="create_by_id">
                    @foreach($create_bies as $id => $create_by)
                        <option value="{{ $id }}" {{ ($rfa->create_by ? $rfa->create_by->id : old('create_by_id')) == $id ? 'selected' : '' }}>{{ $create_by }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('receive_date') ? 'is-invalid' : '' }}" type="text" name="receive_date" id="receive_date" value="{{ old('receive_date', $rfa->receive_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('note_2') ? 'is-invalid' : '' }}" name="note_2" id="note_2">{!! old('note_2', $rfa->note_2) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note_3') ? 'is-invalid' : '' }}" name="note_3" id="note_3">{{ old('note_3', $rfa->note_3) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('document_status') ? 'is-invalid' : '' }}" name="document_status_id" id="document_status_id">
                    @foreach($document_statuses as $id => $document_status)
                        <option value="{{ $id }}" {{ ($rfa->document_status ? $rfa->document_status->id : old('document_status_id')) == $id ? 'selected' : '' }}>{{ $document_status }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('construction_contracts') ? 'is-invalid' : '' }}" name="construction_contracts[]" id="construction_contracts" multiple>
                    @foreach($construction_contracts as $id => $construction_contract)
                        <option value="{{ $id }}" {{ (in_array($id, old('construction_contracts', [])) || $rfa->construction_contracts->contains($id)) ? 'selected' : '' }}>{{ $construction_contract }}</option>
                    @endforeach
                </select>
