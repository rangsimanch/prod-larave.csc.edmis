...
@section('content')
<div class="content">
    @can('as_build_plan_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.as-build-plans.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.asBuildPlan.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.asBuildPlan.title_singular') }} {{ trans('global.list') }}
                </div>
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AsBuildPlan">
                        <thead>
                            <tr>
                                <th width="10">
...
@can('as_build_plan_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.as-build-plans.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.as-build-plans.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}', searchable: false }
  ...
  let table = $('.datatable-AsBuildPlan').DataTable(dtOverrideGlobals);
