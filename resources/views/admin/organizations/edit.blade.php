                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.organizations.update", [$organization->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title_th') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_th" id="title_th" value="{{ old('title_th', $organization->title_th) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('title_en') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title_en" id="title_en" value="{{ old('title_en', $organization->title_en) }}">
                        ...
                        <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $organization->code) }}">
                            @if($errors->has('code'))
