        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.srtExternalAgencyDocument.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.srt-external-agency-documents.update", [$srtExternalAgencyDocument->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('construction_contracts') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="construction_contracts[]" id="construction_contracts" multiple>
                                @foreach($construction_contracts as $id => $construction_contract)
                                    <option value="{{ $id }}" {{ (in_array($id, old('construction_contracts', [])) || $srtExternalAgencyDocument->construction_contracts->contains($id)) ? 'selected' : '' }}>{{ $construction_contract }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="subject" id="subject" value="{{ old('subject', $srtExternalAgencyDocument->subject) }}">
                        ...
                        <div class="form-group {{ $errors->has('document_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="document_type" id="document_type">
                                ...
                                @foreach(App\SrtExternalAgencyDocument::DOCUMENT_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('document_type', $srtExternalAgencyDocument->document_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('originator_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="originator_number" id="originator_number" value="{{ old('originator_number', $srtExternalAgencyDocument->originator_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('incoming_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="incoming_date" id="incoming_date" value="{{ old('incoming_date', $srtExternalAgencyDocument->incoming_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('refer_to') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="refer_to" id="refer_to" value="{{ old('refer_to', $srtExternalAgencyDocument->refer_to) }}">
                        ...
                        <div class="form-group {{ $errors->has('from') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="from" id="from" value="{{ old('from', $srtExternalAgencyDocument->from) }}">
                            @if($errors->has('from'))
                        ...
                        <div class="form-group {{ $errors->has('to') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="to" id="to" value="{{ old('to', $srtExternalAgencyDocument->to) }}">
                            @if($errors->has('to'))
                        ...
                        <div class="form-group {{ $errors->has('attachments') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="attachments" id="attachments" value="{{ old('attachments', $srtExternalAgencyDocument->attachments) }}">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $srtExternalAgencyDocument->description) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('speed_class') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="speed_class" id="speed_class">
                                ...
                                @foreach(App\SrtExternalAgencyDocument::SPEED_CLASS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('speed_class', $srtExternalAgencyDocument->speed_class) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('objective') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="objective" id="objective">
                                ...
                                @foreach(App\SrtExternalAgencyDocument::OBJECTIVE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('objective', $srtExternalAgencyDocument->objective) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('signatory') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="signatory" id="signatory" value="{{ old('signatory', $srtExternalAgencyDocument->signatory) }}">
                        ...
                        <div class="form-group {{ $errors->has('document_storage') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="document_storage" id="document_storage" value="{{ old('document_storage', $srtExternalAgencyDocument->document_storage) }}">
                        ...
                        <div class="form-group {{ $errors->has('note') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="note" id="note">{{ old('note', $srtExternalAgencyDocument->note) }}</textarea>
                            @if($errors->has('note'))
                        ...
                        <div class="form-group {{ $errors->has('close_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="close_date" id="close_date" value="{{ old('close_date', $srtExternalAgencyDocument->close_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('save_for') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="save_for" id="save_for" required>
                                ...
                                @foreach(App\SrtExternalAgencyDocument::SAVE_FOR_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('save_for', $srtExternalAgencyDocument->save_for) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
