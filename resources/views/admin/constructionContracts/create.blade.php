    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.construction-contracts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_start_1') ? 'is-invalid' : '' }}" type="text" name="dk_start_1" id="dk_start_1" value="{{ old('dk_start_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_end_1') ? 'is-invalid' : '' }}" type="text" name="dk_end_1" id="dk_end_1" value="{{ old('dk_end_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_start_2') ? 'is-invalid' : '' }}" type="text" name="dk_start_2" id="dk_start_2" value="{{ old('dk_start_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_end_2') ? 'is-invalid' : '' }}" type="text" name="dk_end_2" id="dk_end_2" value="{{ old('dk_end_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_start_3') ? 'is-invalid' : '' }}" type="text" name="dk_start_3" id="dk_start_3" value="{{ old('dk_start_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dk_end_3') ? 'is-invalid' : '' }}" type="text" name="dk_end_3" id="dk_end_3" value="{{ old('dk_end_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('roadway_km') ? 'is-invalid' : '' }}" type="number" name="roadway_km" id="roadway_km" value="{{ old('roadway_km') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tollway_km') ? 'is-invalid' : '' }}" type="number" name="tollway_km" id="tollway_km" value="{{ old('tollway_km') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_distance_km') ? 'is-invalid' : '' }}" type="text" name="total_distance_km" id="total_distance_km" value="{{ old('total_distance_km', '') }}">
