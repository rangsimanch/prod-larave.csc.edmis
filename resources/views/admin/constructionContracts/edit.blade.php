                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.construction-contracts.update", [$constructionContract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $constructionContract->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $constructionContract->code) }}" required>
                            @if($errors->has('code'))
                        ...
                        <div class="form-group {{ $errors->has('document_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="document_code" id="document_code" value="{{ old('document_code', $constructionContract->document_code) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_start_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_start_1" id="dk_start_1" value="{{ old('dk_start_1', $constructionContract->dk_start_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_end_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_end_1" id="dk_end_1" value="{{ old('dk_end_1', $constructionContract->dk_end_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_start_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_start_2" id="dk_start_2" value="{{ old('dk_start_2', $constructionContract->dk_start_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_end_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_end_2" id="dk_end_2" value="{{ old('dk_end_2', $constructionContract->dk_end_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_start_3') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_start_3" id="dk_start_3" value="{{ old('dk_start_3', $constructionContract->dk_start_3) }}">
                        ...
                        <div class="form-group {{ $errors->has('dk_end_3') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="dk_end_3" id="dk_end_3" value="{{ old('dk_end_3', $constructionContract->dk_end_3) }}">
                        ...
                        <div class="form-group {{ $errors->has('roadway_km') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="roadway_km" id="roadway_km" value="{{ old('roadway_km', $constructionContract->roadway_km) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tollway_km') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tollway_km" id="tollway_km" value="{{ old('tollway_km', $constructionContract->tollway_km) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('total_distance_km') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="total_distance_km" id="total_distance_km" value="{{ old('total_distance_km', $constructionContract->total_distance_km) }}">
                        ...
                        <div class="form-group {{ $errors->has('budget') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="budget" id="budget" value="{{ old('budget', $constructionContract->budget) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('works_code') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="works_code_id" id="works_code_id">
                                @foreach($works_codes as $id => $works_code)
                                    <option value="{{ $id }}" {{ (old('works_code_id') ? old('works_code_id') : $constructionContract->works_code->id ?? '') == $id ? 'selected' : '' }}>{{ $works_code }}</option>
                                @endforeach
                            </select>
