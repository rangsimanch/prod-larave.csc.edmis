...
@section('content')
<div class="content">
    @can('letter_outgoing_srt_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route("admin.letter-outgoing-srts.create") }}">
                    {{ trans('global.add') }} {{ trans('cruds.letterOutgoingSrt.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('cruds.letterOutgoingSrt.title_singular') }} {{ trans('global.list') }}
                </div>
...
@can('letter_outgoing_srt_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.letter-outgoing-srts.massDestroy') }}",
...
let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.letter-outgoing-srts.index') }}",
    columns: [
