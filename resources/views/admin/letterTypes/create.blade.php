        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.letter-types.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('type_title') ? 'has-error' : '' }}">
                            <label for="type_title">{{ trans('cruds.letterType.fields.type_title') }}</label>
                            <input class="form-control" type="text" name="type_title" id="type_title" value="{{ old('type_title', '') }}">
