        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.documentsAndAssignment.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.documents-and-assignments.update", [$documentsAndAssignment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('file_name') ? 'has-error' : '' }}">
                            <label for="file_name">{{ trans('cruds.documentsAndAssignment.fields.file_name') }}</label>
                            <input class="form-control" type="text" name="file_name" id="file_name" value="{{ old('file_name', $documentsAndAssignment->file_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('original_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="original_no" id="original_no" value="{{ old('original_no', $documentsAndAssignment->original_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('receipt_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receipt_no" id="receipt_no" value="{{ old('receipt_no', $documentsAndAssignment->receipt_no) }}">
                        ...
                        <div class="form-group {{ $errors->has('date_of_receipt') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="date_of_receipt" id="date_of_receipt" value="{{ old('date_of_receipt', $documentsAndAssignment->date_of_receipt) }}">
