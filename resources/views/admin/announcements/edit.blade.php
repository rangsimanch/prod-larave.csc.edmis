                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.announcements.update", [$announcement->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $announcement->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $announcement->description) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $announcement->start_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $announcement->end_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('announce_contracts') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="announce_contracts[]" id="announce_contracts" multiple>
                                @foreach($announce_contracts as $id => $announce_contract)
                                    <option value="{{ $id }}" {{ (in_array($id, old('announce_contracts', [])) || $announcement->announce_contracts->contains($id)) ? 'selected' : '' }}>{{ $announce_contract }}</option>
                                @endforeach
                            </select>
