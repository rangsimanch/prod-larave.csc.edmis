                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.srt-pd-documents.update", [$srtPdDocument->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('to_text') ? 'has-error' : '' }}">
                            <label for="to_text">{{ trans('cruds.srtPdDocument.fields.operator') }}</label>
                            <input class="form-control" type="text" name="to_text" id="to_text" value="{{ old('to_text', $srtPdDocument->to_text) }}">
